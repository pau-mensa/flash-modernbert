...
- Runner: `benchmarks/showcases/indexing.py`
- RTX 5090 configuration: `benchmarks/configs/index_5090_b128.yml`
- Packed index helpers: `benchmarks/helpers/packed_index.py`
- Generated result: `benchmarks/results/index_5090_b128.json` (ignored)
- Published figures:
  `benchmarks/docs/assets/index_5090_b128_{late_interaction,single_vector}.png`
...
`benchmarks/configs/index_5090_b128.yml` fixes:
...
```bash
nvidia-smi
uv run python -m benchmarks.showcases.indexing benchmarks/configs/index_5090_b128.yml
```

The benchmark takes exclusive use of one GPU. Avoid running other GPU workloads
during measurement.

The command writes the ignored `benchmarks/results/index_5090_b128.json`. The two
