...
- Runner: `benchmarks/showcases/inference.py`
- RTX 5090 configuration: `benchmarks/configs/inference_5090.yml`
- Packed encoding helpers: `benchmarks/helpers/packed_index.py`
- Generated result: `benchmarks/results/inference_5090.json` (ignored)
- Published figures: `benchmarks/docs/assets/inference_5090_{query,document}.png`
...
For every endpoint and variant, `benchmarks/configs/inference_5090.yml` fixes:
...
```bash
nvidia-smi
uv run python -m benchmarks.showcases.inference benchmarks/configs/inference_5090.yml
```
